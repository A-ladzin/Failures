...
def run_full_pipeline(args):
    ...
    pieces = synthesize_timealigned_segments(aligned, tts, speaker_wavs = args.speaker_wavs[0] if len(args.speaker_wavs) else extract_ref_sample(extracted_wav,"speaker_ref.wav"), temp_dir=tmpdir)
