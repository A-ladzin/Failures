...
from tts_pipeline_fast import TTSWrapper,synthesize_timealigned_segments
...
########
    ...
    speaker_wavs = slice_audio_with_margin(extracted_wav,segments,os.path.join(args.output_dir,"speaker_wavs"),margin=30)
    pieces = synthesize_timealigned_segments(aligned, tts, speaker_wavs = speaker_wavs, temp_dir=tmpdir,speed_factor = speed_factor)
